        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('home') }}" class="logo logo-light">
                    <span class="logo-sm">
                      <img src="{{ asset('') }}assets/images/CGC_logo.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                       <img src="{{ asset('') }}assets/images/CGC_logo.png" alt="" width="150" height="60">
                    </span>
                </a>
            </div>
...
{{--                         alt="Header Avatar">--}}
                    <span class="d-none d-xl-inline-block ml-1" style="font-size: 15px"><b>{{ auth()->user()->name }}</b></span>
